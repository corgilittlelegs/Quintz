...
- **Adaptive Auto-Unlock**: Quintz learns a healthy RSSI and link-speed baseline for the locked BSSID. It falls back only after sustained weak signal and degraded link quality, never lowering its safety floor below `-90 dBm`.
